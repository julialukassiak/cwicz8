...
namespace Exercise6
{
    ...
    public static class LinqTasks
    {
        ...
        public static IEnumerable<object> Task11()
        {
            var result = Emps.GroupBy(e => e.Deptno)
                ...
                .Select(g => new { name = g.Key == null ? "Brak departamentu" : g.Key.ToString(), numOfEmployees = g.Count() });
            return result;
        }
        ...
        {
            var result = Emps.EmployeesWithSubordinates();
            return result;
        }
        ...
        {
            var result = Depts.Where(d => !Emps.Any(e => e.Deptno == d.Deptno) || Emps.Count(e => e.Deptno == d.Deptno) == 5)
                .OrderBy(d => d.Dname);
            return result;
        }
    ...
    {
        public static IEnumerable<Emp> EmployeesWithSubordinates(this IEnumerable<Emp> emps)
        {
